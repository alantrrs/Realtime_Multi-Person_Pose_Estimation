...
# Model
pose_deployfile = 'model/_trained_COCO/pose_deploy.prototxt'
pose_model = 'model/_trained_COCO/pose_iter_440000.caffemodel'
boxsize = 368
sigma = 21
npart = 14
stride = 8
padValue = 128
caffe.set_mode_cpu()
net = caffe.Net(pose_deployfile, pose_model, caffe.TEST)
...
# Detect limbs in multiple scales
